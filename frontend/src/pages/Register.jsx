    ...
    <div className="relative min-h-screen overflow-hidden bg-[#fbf7ef] text-black">
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-5 py-10">
        <div className="grid w-full max-w-6xl overflow-hidden rounded-[2.8rem] border border-white/50 bg-white/55 shadow-2xl shadow-black/15 backdrop-blur-2xl lg:grid-cols-[1.05fr_0.95fr]">
          {/* Left Premium Panel */}
          <section className="relative hidden min-h-[700px] overflow-hidden bg-black p-10 text-white lg:block">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(168,85,247,0.55),transparent_32%),radial-gradient(circle_at_85%_80%,rgba(16,185,129,0.45),transparent_36%),radial-gradient(circle_at_45%_60%,rgba(251,146,60,0.35),transparent_28%),linear-gradient(135deg,#080808,#191919)]" />
            ...
            <div className="relative z-10 flex h-full flex-col justify-between">
              ...
              <div>
                ...
                <h2 className="max-w-xl text-6xl font-black leading-[0.9] tracking-[-0.08em]">
                  Build better ads in minutes.
                </h2>

                <p className="mt-6 max-w-md text-sm font-semibold leading-7 text-white/52">
                  Create your AI workspace for ad design ideas, social captions,
                  WhatsApp campaigns and video post concepts.
                </p>

                <div className="mt-10 grid grid-cols-2 gap-4">
                  <div className="float-register rounded-[1.7rem] border border-white/10 bg-white/[0.08] p-5 backdrop-blur-xl">
                  ...
                  <div className="float-register rounded-[1.7rem] border border-white/10 bg-white/[0.08] p-5 backdrop-blur-xl [animation-delay:1.2s]">
                    <h3 className="text-3xl font-black tracking-[-0.05em]">
                      250+
                    </h3>
                    <p className="mt-1 text-xs font-bold text-white/40">
              ...
              <div className="rounded-[1.7rem] border border-white/10 bg-white/[0.08] p-5 backdrop-blur-xl">
                <p className="text-sm font-semibold leading-7 text-white/55">
                  “AdGenie helped us create campaign ideas, captions and post
                  directions faster than our old manual process.”
                </p>
          ...
          <section className="p-6 sm:p-10">
            ...
            <div className="mx-auto max-w-md">
              ...
              <p className="mt-4 text-sm font-semibold leading-6 text-black/50">
                Start generating premium ads, captions and campaign ideas.
              </p>
